                  ...
                  <div class="item">
                     <div class="product-card">
                        ...
                        <div class="text-caption">
                           ...
                           <p> <span class="price-txt">Rs.{{$trendin['single_sales_price']}}</span> <span class="price-oveline">Rs.{{$trendin['single_mrp_price']}}</span>
                     ...
                     <div class="item">
                        <div class="product-card">
                           ...
                           <div class="text-caption">
                              ...
                              <p> <span class="price-txt">Rs.{{$hotesaledata['single_sales_price']}}</span> <span class="price-oveline">Rs.{{$hotesaledata['single_mrp_price']}}</span>
                                <span class="discount-text">
                         ...
                         <div class="item">
                            <div class="product-card">
                               ...
                               <div class="text-caption">
                                  ...
                                  <p> <span class="price-txt">Rs.{{$latestdata['single_sales_price']}}</span> <span class="price-oveline">Rs.{{$latestdata['single_mrp_price']}}</span>
                                    <span class="discount-text">
                                       {{$latestdata['discount']}}
                         ...
                         <div class="item">
                            <div class="product-card">
                               ...
                               <div class="text-caption">
                                  ...
                                  <p> <span class="price-txt">Rs.{{$trend['single_sales_price']}}</span> <span class="price-oveline">Rs.{{$trend['single_mrp_price']}}</span>
                                    <span class="discount-text">
                                        {{$trend['discount']}}
