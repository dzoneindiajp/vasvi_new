               ...
               <div class="col-md-6 col-sm-6">
                  <div class="row">
                     <div class="col-md-12">
                        ...
                        </span> <span class="cut-price"><i class="fas fa-rupee-sign" style="font-size:14px;"></i>
                            <span class="dmrp-price">{{$mrp_price}}</span>
                        </span> <span class="text-success txt-discount">
                               ...
                               <div class="item">
                                  <div class="product-card">
                                     ...
                                     <div class="text-caption">
                                        ...
                                        <p> <span class="price-txt">Rs.{{$trendin['single_sales_price']}}</span> <span class="price-oveline">Rs.{{$trendin['single_mrp_price']}}</span> <span class="discount-text">
                                            {{$trendin['discount']}}
