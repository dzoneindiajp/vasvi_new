<div class="modal fade" id="sizePopModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 quick_right">
            ...
            <div class="product-price"><span class="bold-price"><i class="fas fa-rupee-sign" style="font-size:18px;"></i> <span class="dsale-price">{{$sales_price}}</span></span> <span class="cut-price"><i class="fas fa-rupee-sign" style="font-size:14px;"></i>
               <span class="dmrp-price"> {{$mrp_price}}</span></span> <span class="text-success txt-discount">
